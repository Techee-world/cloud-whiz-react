...
function Mentor() {
  ...
  return (
    <div className="w-full  md:h-[85vh] relative  md:pl-[33px]  p-10 ">
      <div className="max-w-4xl m-auto  ">
        <h1 className="text-center text-3xl md:text-4xl text-sky-600 font-bold mb-6">Our Mentor</h1>
      ...
      <IoIosArrowForward
        onClick={sideLeft}
        className="z-[1]  absolute top-[14rem] right-10 md:-right-[5px]  md:top-[16rem] bg-white md:bg-gradient-to-l from-sky-600 via-sky-500 to-sky-400 p-1 h-8 cursor-pointer w-8 rounded-full  md:right-1"
      />
      <div
        id="sliderE"
        class="flex w-[21rem]  md:w-[70rem] gap-[2rem] md:mx-4 overflow-y-hidden scroll-smooth overflow-x-scroll scrollbar-hide   items-start my-4 "
      >
